    ...
    <section className="relative w-full h-[300px] md:h-[350px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-3xl">
        ...
        <p className="text-sm md:text-base opacity-90 font-light">
          Cakra menyediakan layanan pengembangan website dan solusi IT yang dirancang untuk membantu bisnis tampil profesional, 
          meningkatkan kredibilitas, dan tumbuh di era digital.
        </p>
      </div>
    </section>
  );
